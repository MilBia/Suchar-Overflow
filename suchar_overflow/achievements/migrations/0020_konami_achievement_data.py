...
def create_konami_achievement(apps, schema_editor):
    ...
    Achievement.objects.update_or_create(
        ...
        defaults={
            ...
            "description": (
                "↑ ↑ ↓ ↓ ← → ← → B A"
                " — i posypał się deszcz krakersów."
            ),
            "description_pl": (
                "↑ ↑ ↓ ↓ ← → ← → B A"
                " — i posypał się deszcz krakersów."
            ...
            "description_en": (
                "↑ ↑ ↓ ↓ ← → ← → B A"
                " — and down came the cracker rain."
            ),
            "icon_content": ICON_CONTROLLER,
            "category": "LIFETIME",
            "event_type": "FRONTEND",
...
class Migration(migrations.Migration):
    dependencies = [
        ("achievements", "0019_recydywa_achievement_data"),
    ]

    operations = [
        migrations.RunPython(
            create_konami_achievement,
